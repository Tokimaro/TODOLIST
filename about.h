...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Arial Rounded MT Bold", 20.25F));
			this->label1->Location = System::Drawing::Point(53, 67);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(565, 32);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Эта программа была созданна в 2019 году.";
			...
			this->ClientSize = System::Drawing::Size(668, 178);
